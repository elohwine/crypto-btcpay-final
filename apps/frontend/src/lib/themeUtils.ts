...
export function getPrimaryForTheme(
  theme: MantineTheme | any,
  ...
  if (colors && colors.blue && Array.isArray(colors.blue))
    return colors.blue[6] || "#228be6";
  return "#228be6";
}
...
export function useAppTheme() {
  ...
  const primary = getPrimaryForTheme(
    theme as any,
